...
log(mp.sup)
tf.info(" now running opr._extend('items', cls='OProxyContainer', dat='extensions_for_tests', monkey_patch=True)" )
opr._extend('items', cls='OProxyContainer', dat='extensions_for_tests', monkey_patch=True)
