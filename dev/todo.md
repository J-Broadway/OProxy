Make returnObj flag _returnObj for internal use only
Extensions documentation needs an Monkey Patch Wrapper (advanced usage) example where inheritance is used IE
